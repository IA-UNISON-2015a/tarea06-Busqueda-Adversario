...
class Othello(JuegoSumaCeros2T.Juego2ZT):
    
    def __init__(self):
        ini = [0]*64
        ini[27], ini[36], ini[28], ini[35] = 1,1,-1,-1
        JuegoSumaCeros2T.Juego2ZT.__init__(self,8,8, ini)
...
class JugadorOthello(JuegoSumaCeros2T.JugadorNegamax):
    
    def __init__(self, tiempo_espera):
        JuegoSumaCeros2T.JugadorNegamax.__init__(self, d_max=1)
...
if __name__ == '__main__':
    juego = JuegoSumaCeros2T.InterfaseTK(Othello(),
                                        JugadorOthello(4),
                                        JugadorOthello(4),
                                        1)
