...
class Conecta4(JuegoSumaCeros2T):
    ...
    def __init__(self):
        ...
        """
                    JuegoSumaCeros2T.__init__(self,
                                              7, 6,
...
class JugadorConecta4(JuegoSumaCeros2T.JugadorNegamax):
    """
...
if __name__ == '__main__':
    ...
    juego = JuegoSumaCeros2T.InterfaseTK(Conecta4(),
                                          JuegoSumaCeros2T.JugadorHumano(),
                                          JugadorConecta4(4),
                                          1)
    juego.arranca()